 ...
 */
@JsonPropertyOrder({
  ResponseFormat.JSON_PROPERTY_TYPE
})
...
public class ResponseFormat {
  ...
  public ResponseFormat type(@jakarta.annotation.Nullable ResponseFormats type) {
  ...
  @JsonProperty(JSON_PROPERTY_TYPE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setType(@jakarta.annotation.Nullable ResponseFormats type) {
    this.type = type;
  }
