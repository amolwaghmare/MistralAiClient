 ...
 */
@JsonPropertyOrder({
  ToolChoice.JSON_PROPERTY_TYPE,
  ToolChoice.JSON_PROPERTY_FUNCTION
})
@JsonTypeName("Tool_Choice")
...
public class ToolChoice {
  ...
  public ToolChoice type(@jakarta.annotation.Nullable ToolTypes type) {
  ...
  public ToolChoice function(@jakarta.annotation.Nonnull FunctionName function) {
  ...
  @JsonProperty(JSON_PROPERTY_FUNCTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setFunction(@jakarta.annotation.Nonnull FunctionName function) {
    this.function = function;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, toolChoice.type) &&
        Objects.equals(this.function, toolChoice.function);
  }
